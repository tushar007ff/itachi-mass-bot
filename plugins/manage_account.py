...
@Client.on_message(filters.private & filters.user(Config.SUDO) & filters.user(Config.OWNER) & filters.command('add_account'))
...
@Client.on_message(filters.private & filters.user(Config.SUDO) & filters.user(Config.OWNER) & filters.command('target'))
...
@Client.on_message(filters.private & filters.user(Config.SUDO) & filters.user(Config.OWNER) & filters.command('del_config'))
